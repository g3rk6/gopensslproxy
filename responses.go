...
//
//	proxy.OnRequest(IsLocalHost()).DoFunc(func(r *http.Request, ctx *gopensslproxy.ProxyCtx) (*http.Request,*http.Response) {
//		return nil,NewResponse(r,gopensslproxy.ContentTypeHtml,http.StatusUnauthorized,
