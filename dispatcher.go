...
//	proxy.OnRequest().HandleConnect(gopensslproxy.AlwaysReject) // rejects all CONNECT requests
...
//	proxy.OnRequest(gopensslproxy.ReqHostIs("www.google.com")).HandleConnect(gopensslproxy.AlwaysMitm)
...
//	proxy.OnRequest(gopensslproxy.Not(gopensslproxy.ReqHostMatches(regexp.MustCompile(":443$"))).
//		HandleConnect(gopensslproxy.AlwaysReject)
