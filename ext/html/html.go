...
func HandleString(f func(s string, ctx *gopensslproxy.ProxyCtx) string) gopensslproxy.RespHandler {
	return HandleStringReader(func(r io.Reader, ctx *gopensslproxy.ProxyCtx) io.Reader {
...
func HandleStringReader(f func(r io.Reader, ctx *gopensslproxy.ProxyCtx) io.Reader) gopensslproxy.RespHandler {
	return gopensslproxy.FuncRespHandler(func(resp *http.Response, ctx *gopensslproxy.ProxyCtx) *http.Response {
		if ctx.Error != nil {
			return nil
		}
